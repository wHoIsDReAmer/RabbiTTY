...
pub(super) struct TerminalFileConfig {
    ...
    pub(super) wheel_zoom: Option<bool>,
    pub(super) osc52_write: Option<bool>,
    pub(super) osc52_read: Option<bool>,
    ...
    fn from(config: &AppConfig) -> Self {
        Self {
            ...
            terminal: Some(TerminalFileConfig {
                ...
                wheel_zoom: Some(config.terminal.wheel_zoom),
                osc52_write: Some(config.terminal.osc52_write),
                osc52_read: Some(config.terminal.osc52_read),
