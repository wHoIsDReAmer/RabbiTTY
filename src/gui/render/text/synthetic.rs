//! Box drawing, block elements and braille drawn to the cell.
//! Font glyphs land on fractional positions, so neighbouring cells never meet.
...
impl Canvas {
    ...
    /// Half open and clamped, so adjacent shapes abut.
...
mod tests {
    ...
    fn an_unmapped_box_character_falls_back_to_the_font() {
        // Diagonals are not line segments; leave them to the font.
