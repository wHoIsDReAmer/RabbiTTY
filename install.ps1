...
# The archives are unsigned; a hash mismatch must abort before extraction.
...
# A raw registry write preserves REG_EXPAND_SZ but does not notify running processes.
