...
# The archives are unsigned; the SHA256SUMS file is the only integrity check.
verify_sha256() {
    dir="$1"
    name="$2"
    ...
    # Compared exactly rather than by regex so dots in the name cannot match loosely.
